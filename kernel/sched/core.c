...
void ipc_balance(void)
{
	...
	//printk(KERN_INFO "CS1651 MIN CPU: %d Cycles: %lld", min_cpu, min_cpu_wasted_cycles);
	//printk(KERN_INFO "CS1651 MAX CPU: %d Cycles: %lld", max_cpu, max_cpu_wasted_cycles);
...
void scheduler_tick(void)
{
	...
	// //1651
	// //if time is greater than 1 second (1s = 1000000000 ns)since last ipc balance, then rebalance
	// //if(rq->cpu == 0 && rq->clock > 60000000000 && rq->clock - rq->last_rebalance > 8000000000){
	// if(rq->cpu == 0 && rq->clock - rq->last_rebalance > 8000000000){
	// 	//printk(KERN_INFO "cs1651_rebalance");
	// 	ipc_balance();
	// 	rq->last_rebalance = rq->clock;
	// }
	// //1651 end
#ifdef CONFIG_SMP
